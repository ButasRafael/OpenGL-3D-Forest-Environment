...
float u_WindStrength = 0.5f; 
float gustSize = 0.25f;
float gustSpeed = 0.75f;
float windWaveLength = 4.0f; 
...
void retrieveBasicUniformLocations() {
    ...
    basicUniforms.leftHeadlight.diffuse = glGetUniformLocation(myBasicShader.shaderProgram, "leftHeadlight.diffuse");
...
void respawnFireParticle(FireParticle& p)
{
    ...
    p.position = glm::vec3(pointLight.position.x, 0.2f, pointLight.position.z) + glm::vec3(xOff, yOff, zOff);
...
void initModels() {
    forest.LoadModel("models/forest/Evergreen_Forest_final.obj");
...
void initFire()
{
    ...
    std::vector<std::string> firePaths = {
        "models/forest/textures/fire1.png",
        "models/forest/textures/fire2.png",
        "models/forest/textures/fire3.png",
        "models/forest/textures/fire4.png",
        "models/forest/textures/fire5.png",
        "models/forest/textures/fire6.png",
		"models/forest/textures/fire7.png",
		"models/forest/textures/fire8.png",
		"models/forest/textures/fire9.png",
		"models/forest/textures/fire10.png"
    };
...
void updateFire(float deltaTime, float globalTime)
{
    for (auto& p : fireParticles)
    {
        ...
        if (p.type == 0) {
            ...
            float heightAbove = p.position.y - 0.2f;
...
void renderScene() {
    ...
    waterRenderer->render(waterTiles, projection, view, myCamera.getPosition(), reflectionTexture, refractionTexture, depthTexture, deltaTime, lakeLightPosition, lakeLightColor);
    if (performHDR) {
        glBindFramebuffer(GL_FRAMEBUFFER, 0);
    }
